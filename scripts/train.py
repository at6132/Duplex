"""
Training CLI for Duplex-1.1-1.7B v2.
...
Resume Phase 2:
    torchrun --nproc_per_node=2 scripts/train.py --phase 2 --resume checkpoints/duplex-1.1-1.7b/phase1_best.pt
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Train Duplex-1.1-1.7B v2")
    ...
    parser.add_argument("--checkpoint_dir", type=str, default="checkpoints/duplex-1.1-1.7b")
    ...
    if is_main:
        print("Loading Duplex-1.1-1.7B v2...")
