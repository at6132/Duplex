"""
Investor demo: side-by-side streaming comparison of vanilla Qwen vs Duplex-1.3-1.7B.
...
def main():
    ...
    with gr.Blocks(title="Duplex-1 Demo") as demo:
        ...
        <div style="text-align:center; padding: 20px 0 10px 0;">
            <h1 style="font-size:2.2rem; margin:0;">Duplex-1.3-1.7B</h1>
        ...
        with gr.Row():
            ...
            with gr.Column():
                gr.HTML('<div style="font-weight:600; color:#4ade80; font-size:1.05rem; margin-bottom:4px;">Duplex-1.3-1.7B (Full-Duplex)</div>')
